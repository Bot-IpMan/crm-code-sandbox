...
- **Створюйте картки для кожного клієнта/ліда** з шаблона, фіксуючи всі ключові дані й оновлюючи статуси.
- **Ведіть хронологію взаємодій** у відповідних нотатках або через щоденники з backlink-ами.
- **Контролюйте статуси лідів** за єдиною шкалою та створіть нотатку «Sales Pipeline» з Dataview-запитами або канбан-дошку для воронки.[^2]
- **Зв’язуйте контакти та організації** через внутрішні посилання; у YAML можна додати список відповідальних осіб.
- **Будуйте дашборди клієнтів** (наприклад, кількість активних задач, дата останнього контакту) за допомогою Dataview або DataviewJS.
- **Опрацьовуйте угоди (Deals)** як окремі нотатки чи поля клієнтів/лідів; використовуйте Kanban або звіти для візуалізації статусів.[^1]
- **Додавайте швидкі дії**: посилання `tel:` та `mailto:` для миттєвих дзвінків і листів, URI на Zoom чи LinkedIn.

---

## Крок 5. Управління завданнями й проєктами
- **Фіксуйте задачі там, де вони виникають**: у нотатках клієнтів або проєктів використовуйте чекбокси `- [ ]` із дедлайнами (`📅 YYYY-MM-DD`).
- **Створіть «Tasks Dashboard»** із Dataview або плагіном Tasks, щоб бачити всі відкриті задачі, наприклад:
  ```dataview
  TASK
  WHERE !completed
  SORT due ASC
  ```
- **Фільтруйте задачі** за клієнтами чи тегами (`#call`, `#email`, `#research`).
- **Використовуйте канбан-дошки** для візуального контролю великих проєктів або воронок угод.
- **Налаштуйте контроль виконання**: переглядайте Tasks Dashboard, інтегруйте календар чи зовнішній таск-трекер за потреби.[^1]
